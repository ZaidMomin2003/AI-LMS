'use server';
/**
 * @fileOverview An AI agent that generates flashcards on a given topic.
 *
...
const prompt = ai.definePrompt({
  ...
  Generate a set of 5 to 10 flashcards for the following topic. Each flashcard should have a term and a definition.
