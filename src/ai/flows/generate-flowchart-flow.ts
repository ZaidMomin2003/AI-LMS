...
/**
 * @fileOverview An AI agent that generates a flowchart SVG from syllabus topics.
 *
...
export async function generateFlowchart(
  ...
  const llmResponse = await ai.generate({
    prompt: `You are an expert in instructional design and data visualization. Your task is to create a clear, concise, and visually appealing flowchart from a given list of syllabus topics.

    **Instructions:**
    1.  Analyze the provided topics and determine their logical sequence and relationships.
    ...
    **Example SVG output format:**
    ...
    Now, generate the SVG for the topics above.`,
  });
