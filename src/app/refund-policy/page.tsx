            ...
            <main className="flex-grow container mx-auto px-4 py-12 md:py-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-invert max-w-none bg-card p-8 md:p-12 rounded-2xl border border-border/50 shadow-lg">
                        ...
                        <p>wisdom provides immediate access to digital content and AI-powered services. The generation of study materials incurs an instant and irreversible cost to us. Because our services are delivered instantly upon request and cannot be "returned," we are unable to provide refunds.</p>

                        <h3>Free Plan</h3>
                        <p>We offer a free plan for you to try our services before committing to a paid subscription. We encourage you to use this plan to determine if wisdom is the right fit for your needs before purchasing a subscription.</p>
