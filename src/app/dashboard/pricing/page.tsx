...
const weeklyPlan: Plan = {
    name: 'Weekly Pass',
    price: 4.99,
    priceDescription: '7 days of unlimited access',
    durationDays: 7,
};
            ...
            <div className="flex-1 p-4 md:p-8 flex flex-col items-center justify-center bg-zinc-900 text-white">
                <div className="w-full max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        {/* Right Side: Weekly Pass */}
                        <Card className="flex flex-col justify-between p-8 bg-zinc-900 border-zinc-800">
                             <div>
                                <h3 className="text-2xl font-bold font-headline text-yellow-400">Weekly Pass</h3>
                                <p className="text-zinc-300 mt-2">Perfect for a final exam push or trying out all pro features.</p>
                                <div className="mt-6">
                                    <span className="text-4xl font-bold">${weeklyPlan.price}</span>
                                    <span className="text-zinc-400">/ 7 days</span>
                                </div>
                                <ul className="space-y-3 pt-6">
                                    <li className="flex items-center gap-3 text-sm text-zinc-300">
                                        <Check className="w-5 h-5 text-yellow-400" />
                                        <span>Full access to all Pro features for 7 days</span>
                                    </li>
                                     <li className="flex items-center gap-3 text-sm text-zinc-300">
                                        <Check className="w-5 h-5 text-yellow-400" />
                                        <span>One-time payment, no recurring subscription</span>
                                    </li>
                                </ul>
                             </div>
                             <div className="mt-8">
                                {subLoading || isLoading ? (
                                    ...
                                    <Button
                                        size="lg"
                                        className="w-full font-bold text-base bg-yellow-400 text-black hover:bg-yellow-300"
                                        onClick={() => handlePayment(weeklyPlan)}
                                    >
                                        Get Weekly Pass
                                    </Button>
                                )}
